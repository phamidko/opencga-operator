...
type Versioned interface {
	client.Object
	GetOpenCGAVersionForAnnotation() string
...
const (
	LastAppliedOpenCGAVersion = "OpenCGA.com/v1.lastAppliedOpenCGAVersion"
)
...
func UpdateLastAppliedOpenCGAVersion(mdb Versioned, kubeClient client.Client) error {
	annotations := map[string]string{
		LastAppliedOpenCGAVersion: mdb.GetOpenCGAVersionForAnnotation(),
	}
